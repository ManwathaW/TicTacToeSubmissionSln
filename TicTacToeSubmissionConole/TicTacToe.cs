...
namespace TicTacToeSubmissionConsole
{
    public class TicTacToe
    {
        ...
        // 3x3 character array to store the board state
        ...
        public void Run()
        {
            int turns = 0; // Counter for number of turns taken

            while (true)
            {
                Console.Clear(); // Clear console for clean board display
        ...
        private void RenderBoard()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Console.SetCursorPosition(6, 7 + 2 * i);
